...
public class EventReceiverSpout extends BaseRichSpout implements AgentCallback {
    ...
    private int cepMangerPort = 9773;

    private String cepMangerHost = "localhost";
    ...
    public EventReceiverSpout(int listeningPort, String[] incomingStreamDefinitions){
        ...
        System.setProperty("Security.KeyStore.Location", "/home/sajith/wso2cep-4.0.0-SNAPSHOT/samples/producers/performance-test/src/main/resources/wso2carbon.jks");
